...
function run() {
    ...
    // https://fidebleb.sirv.com/cat_images/cat1.jpeg 
    var location = `https://fidebleb.sirv.com/cat_images/cat${num}.jpeg`
    //var location = `/bg.gif`
    ...
    // images to be blacklisted
    // 252 287 84 299 318 281 69
    
    
    /*Downloaded from https://www.codeseek.co/linrock/falling-confetti-Amdhr */
    (function() {
